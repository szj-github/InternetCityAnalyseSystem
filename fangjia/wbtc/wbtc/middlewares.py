...
class WbtcSpiderMiddleware(object):
...
class WbtcDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
class RandomUserAgent(UserAgentMiddleware):
    ...
    def process_request(self, request, spider):
        ...
        'UMozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Trident/5.0',
        ...
        ip_port = '61.138.222.48:23564' # 从api中提取出来的代理IP:PORT
        
        username = '785276461@qq.com'
        password = 'Wandou123'
       ...
       # request.headers['Proxy-Authorization'] = 'Basic'+str(base_code(username, password))
